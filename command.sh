...
if [[ "$1" == daemon ]];then
   ...
   java -Djdk.tls.namedGroups="secp256r1,secp256k1" -cp dist/conf/:dist/lib/*:dist/app/* com.webank.weid.demo.command.DemoCommand $1 >/dev/null 2>&1 &
    ...
    echo "--------- start $1 ----------"
   java -Djdk.tls.namedGroups="secp256r1,secp256k1" -cp dist/conf/:dist/lib/*:dist/app/* com.webank.weid.demo.command.DemoCommand $1
fi
